...
const RenderCards = ({ data, title }) => {
  ...
  return (
    <h2 className="mt-5 font-bold text-[#15efaa] text-xl uppercase">{title}</h2>
  );
};
...
const Home = () => {
  ...
  const fetchPosts = async () => {
    ...
    try {
      const response = await fetch("https://dalle.amissouri.com/api/v1/post", {
        method: "GET",
        headers: {
    ...
    <section className="max-w-7xl mx-auto">
      ...
      <div className="mt-16">
        <FormField
          ...
          type="text"
          name="text"
          placeholder="Search for prompts used..."
          value={searchText}
